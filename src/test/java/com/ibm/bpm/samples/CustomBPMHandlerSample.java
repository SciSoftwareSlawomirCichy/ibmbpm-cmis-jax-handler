...
public class CustomBPMHandlerSample implements BPMHandler,SOAPHandler<SOAPMessageContext> {
	
	public static final String COPYRIGHT = "\n\n(C) Copyright IBM Corporation 2014.\n\n";
	
	public static final String CLASSNAME = CustomBPMHandlerSample.class.getName();
	...
	public boolean handleMessage(SOAPMessageContext messageContext) {
        ...
        if (outbound) {
        	if (logger.isLoggable(Level.FINE)) {
        		...
        		// Read the default and custom properties
                ...
                for (Object key : properties.keySet()) {
                	...
                	request+=""+key+": "+properties.getProperty((String)key);
                	first = false;
                }
                request+= "))";
